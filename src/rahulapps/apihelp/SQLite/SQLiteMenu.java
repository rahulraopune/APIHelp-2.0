...
public class SQLiteMenu extends SherlockActivity implements OnItemClickListener
{
	ListView lv;
	ArrayAdapter<String> arrayadapter;
	
	String sMenu[]={"SQLite API","SQLite Front-End Code","SQLite Back-End Code","SQLite Output Code"};
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		arrayadapter = new ArrayAdapter<String>(SQLiteMenu.this,android.R.layout.simple_list_item_1,sMenu);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) 
	{
		...
		case 3:ActivityStarter("rahulapps.apihelp.SQLite.SQLiteOutputCode");break;
