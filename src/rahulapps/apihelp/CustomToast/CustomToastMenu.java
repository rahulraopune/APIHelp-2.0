...
public class CustomToastMenu extends SherlockActivity implements OnItemClickListener
{
	ListView lv;
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		arrayadapter = new ArrayAdapter<String>(CustomToastMenu.this,android.R.layout.simple_list_item_1,sMenu);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) 
	{
		...
		switch(position)
		{
		case 0:ActivityStarter("rahulapps.apihelp.CustomToast.CustomToastAPI");break;
		case 1:ActivityStarter("rahulapps.apihelp.CustomToast.CustomToastViewXML");break;
		case 2:ActivityStarter("rahulapps.apihelp.CustomToast.CustomToastLayoutXML");break;
		case 3:ActivityStarter("rahulapps.apihelp.CustomToast.CustomToastToastViewXML");break;
		case 4:ActivityStarter("rahulapps.apihelp.CustomToast.CustomToastCode");break;
		}
	}
