...
public class NavigationDrawerMenu extends SherlockActivity implements OnItemClickListener
{
	...
	String sMenu[]={"Navigation Drawer API","Navigation Drawer.XML","Navigation Drawer Code"};
	...
	protected void onCreate(Bundle savedInstanceState) 
	{
		...
		arrayadapter = new ArrayAdapter<String>(NavigationDrawerMenu.this,android.R.layout.simple_list_item_1,sMenu);
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) 
	{
		...
		switch(position)
		{
		case 0:ActivityStarter("rahulapps.apihelp.NavigationDrawer.NavigationDrawerAPI");break;
		case 1:ActivityStarter("rahulapps.apihelp.NavigationDrawer.NavigationDrawerXML");break;
		case 2:ActivityStarter("rahulapps.apihelp.NavigationDrawer.NavigationDrawerCode");break;
